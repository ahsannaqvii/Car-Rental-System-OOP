			...
			for (int i=0 ; ; i++){
				...
				switch(Option3){
					case 1: {																				//GariKroNow
						...
						R.GariKro_Now();                                                            		//Function of Gari Karo Now
						...
						for (int i=0 ; i<1 ; i++){
							if(R.Search_Vehicle(Type) == 0){
								...
								R.StartingMessage();
								R.DropOffMessage();                                                                                               
								R.Fare_Calculation();                                                               //Calculating fare
								R.rideDetails();
								R.Payment();
								R.Print_Bill();
								R.Changing_Status();
					...
					case 2:  {																				//Gari Schedule Kro
						...
						fflush(stdin);
						getline(cin , dropoff_location);
						R.set_Locations(pickup_location , dropoff_location);                                //Set Pickup and DropOff                         
						R.GariSchedule_Dates();                                                     		//Dates to schedule
						R.GariSchedule_Time();                                                      		//Time slots to schedule
						cout << "\nPlease Select mode of transport: ";
						cout << "\n1.Gari without AC \n2.Gari with AC ";
						cin >> Type;
						for (int i=0 ; ; i++){
					...
					case 3: {
						system("cls");
						PrintTitle();
						R.Notifications();																	// User Notifications
						break;
					}
					case 4: {																				//Account Details 
						...
						switch(Choice){		
							case 1:{
								R.Check_Balance();															//Checking Current Balance
								break;
							}
							case 2:{
								R.Add_Balance();															//Recharing Account
								break;
							}
							case 3: {
								system("cls");
...
//Convert files into Excel - Optional
